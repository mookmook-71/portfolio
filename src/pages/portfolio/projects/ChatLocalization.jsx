      ...
      <div className="portfolio portfolio-detail">
        <div className="card">
          ...
          <div className="project-title">
            ...
            <img src={SideImg} alt="grab ads" className="project-content-img" />
          </div>
          ...
          <div className="project-details">
            ...
            <section>
              ...
              <body4>Content design, customer experience, localization</body4>
            </section>
            ...
            <section>
              ...
              <body4>
                ...
                frustration in case their concerns couldn't be fully addressed.
                We were cautious about using overly human-like language, as it
                could lead to misunderstandings and potentially erode user trust
                and loyalty. Our aim was to apply a consistent product content
                style guide across all products, including the chatbot.
              </body4>
              ...
              <body4>
                ...
                style when communicating with customers, which differs from our
                in-app style. I also discussed unique challenges with
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      in Thai as in real life we would have to end the sentences
                      with gender particles like kha (ค่ะ) and krab (ครับ)
                    </td>
                    <td>
                      Align with the CS team whether we’ll use a feminine or
                      masculine tone and stick to it. Inform the content
                      designers so they’re aware of the gender aspect. If we’ll
                      ever create a persona in the future, they know Thai should
                      be a female.
                    </td>
                    <td></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>
                      Due to different cultural nuances, some messages are going
                      to be different from English source.
                    </td>
                    <td>
            ...
            <section>
              ...
              <p>
                ...
                point, we managed to make it more concise. Usually, we would be
                worried about Thai being too long as Thai is generally longer
                than English.
              </p>
            </section>
            <img src={OutcomeImg} alt="chat localization outcome image" />
